...
{
    public class PatrolLeftToStandLeftTransition : BaseTransition
    {
        ...
        protected override string TargetState => "StandLeft";

        public PatrolLeftToStandLeftTransition(GameObject self) : base(self)
        {
        ...
        protected override bool IsTriggered()
        {
            ...
            Debug.DrawLine(wallRaycastStartPosition, wallRaycastStartPosition + Vector2.left * WallRaycastLength);

            hitCount = Physics2D.RaycastNonAlloc(wallRaycastStartPosition, Vector2.left, hitBuffer, FloorRaycastLength, 1 << LayerMask.NameToLayer("Ground"));
